...
namespace SixLabors.ImageSharp
{
    ...
    public static partial class ImageExtensions
    {
        ...
        {
            return source.Fill(brush, new Shapes.RectangularPolygon(shape.X, shape.Y, shape.Width, shape.Height), options);
        }
        ...
        public static IImageProcessingContext<TPixel> Fill<TPixel>(this IImageProcessingContext<TPixel> source, IBrush<TPixel> brush, RectangleF shape)
            where TPixel : struct, IPixel<TPixel>
        {
            return source.Fill(brush, new Shapes.RectangularPolygon(shape.X, shape.Y, shape.Width, shape.Height));
        }
